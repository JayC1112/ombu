...
- ✅ 删除中文区块（"用餐须知 (Chinese)" 整个 section）
- ✅ Kids Pricing 已更新为身高规则（已确认正确）
- ✅ 页面默认只显示英文
- ✅ Build 通过
- ✅ TypeScript 无错误
...
1. **`src/app/ayce-guidelines/page.tsx`** ⭐ 页面源码
   - ✅ 删除整个 "Chinese Section"（第 312-359 行）
   - ✅ Kids Pricing 已正确更新为身高规则（在 additionalInfo 中）
...
**位置：** `src/app/ayce-guidelines/page.tsx` 第 161-167 行
...
### 内容验证
- ✅ `/ayce-guidelines` 页面不再显示中文内容
- ✅ Kids Pricing 显示为身高规则
- ✅ 页面只显示英文
...
在 `/ayce-guidelines` 页面的 "Additional Information" 区域：
